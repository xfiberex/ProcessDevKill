...
**Pruebas:** 170 de frontend (Vitest + Testing Library, en jsdom) y 61 de `cargo test`. La
...
`npm audit --omit=dev`, todas dentro de `release.ps1`, que aborta si algo falla. **No hay CI ni la
